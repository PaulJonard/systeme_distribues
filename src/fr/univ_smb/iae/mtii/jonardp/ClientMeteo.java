...
public class ClientMeteo {
	...
	/**
	 * Le client est une application Java. Il demande à l'utilisateur de saisir
	 * l'adresse IP du serveur de météo ou son nom (hostname). Ensuite, il se
	 * connecte à ce serveur et affiche ce qui lui retourne le serveur.
	 */
	public static void main(String[] args) throws IOException {
		// On cree un client (au sens un objet de type Client qui va se connecter au
		// serveur...
